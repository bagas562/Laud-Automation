...
test('test', async ({ page }) => {
  ...
  await page.getByRole('link', { name: ' Delivery to Indonesia' }).click();
  await page.locator('tr:nth-child(7) > .dt-checkboxes-cell > .dt-checkboxes').check();
  await page.getByRole('button', { name: 'Arrival to Indonesia ' }).click();
});